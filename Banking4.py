...
def main():
    ...
    print("Amount of USER1 after deposit",User1.Amount)

    print("Amount of USER1 after deposit",User2.Amount)

    User1.Withdraw(500)
    User2.Withdraw(1200)

    print("Amount of USER1 after withdrawl", User1.Amount)

    print("Amount of USER1 after withdrawl", User2.Amount)
